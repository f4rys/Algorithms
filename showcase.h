...
{
    // Variables for longest common prefix and longest palindormic substring algorithms
    const int SIZE = 3;
    string array[SIZE] = {"mango", "manhattan", "manmade"};

    // KMP search variables
...
{
    // N Queens Problem variable
    const int N = 8;

    // Rat in a Maze Problem variable
